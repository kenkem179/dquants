...
construction in cpp_core/tools/common/validate_parity_py.py (which matched the MT5 tester).
...
Usage:
  python cpp_core/tools/common/export_bars.py [year] [clean|raw] [end_date] [out_csv] [symbol]
...
Example (the 1-year MT5 run spans 2025-08..11):
  python cpp_core/tools/common/export_bars.py 2025 clean 2025-12-01 cpp_core/tools/bars_btcusd_2025_m3.csv
"""
import sys
import duckdb
