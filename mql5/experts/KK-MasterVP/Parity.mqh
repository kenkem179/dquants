...
//+------------------------------------------------------------------+
#ifndef KKMVP_PARITY_MQH
#define KKMVP_PARITY_MQH
...
void ParityInit()
{
   ...
   string fname = StringFormat("KK-MasterVP\\trades_%s_%s.csv", _Symbol, EnumToString((ENUM_TIMEFRAMES)Period()));
