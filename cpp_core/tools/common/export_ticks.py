...
Usage:
  python cpp_core/tools/common/export_ticks.py <year> <clean|raw> <START> <END> <out_csv> [symbol]
Example (the 1-year MT5 run's test period, BTCUSD M3 2025-08-11..11-30):
  python cpp_core/tools/common/export_ticks.py 2025 clean 2025-08-11 2025-12-01 \\
